                    ...
                    <div class="flex flex-col">
                        <div class="flex border-b border-gray-500">
                            <a href="detail.php?id=<?php echo $buku['buku_id']; ?>">
                                <img src="img/<?php echo $buku['gambar'];?>" alt=" " class="max-w-32  py-3">
                            </a>
                            <div class="flex flex-col p-2 ">
                                <a  href="detail.php?id=<?php echo $buku['buku_id']; ?>" class="font-bold text-xl"><?php echo $buku['judul']; ?></a>
                                <div class="text-sm"><?php echo $buku['tahun']?></div>
                                <div class="flex">
                                    <!-- <img src="img/star.png" alt="star" class="h-6 w-auto mr-1"> -->
                                    <!-- <div><?php echo $buku['rating']?></div> -->
                                ...
                                <div class=""><?php echo $buku['sinopsis']?></div>
                                <div class="py-5 flex">
                                    <div class="mr-1">Penulis</div>
                                    <div class="mr-1 " style="color: cornflowerblue;"><?php echo $buku['penulis']?></div>
                                    <div class="mr-1">Penerbit</div>
                                    <div class="mr-3" style="color: cornflowerblue;"><?php echo $buku['penerbit']?></div>
