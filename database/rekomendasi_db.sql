...
INSERT INTO `buku` (`buku_id`, `judul`, `rating`, `sinopsis`, `gambar`, `penulis`, `penerbit`, `tahun`, `favorit`, `pembaca`, `halaman`) VALUES
(2, 'Tentang Kamu', 0.0, 'Legenda dari Jawa Barat tentang seorang anak laki-laki bernama Sangkuriang yang mencari ibunya dan tanpa sengaja jatuh cinta padanya. Kisah ini penuh dengan tragedi dan kutukan.', 'TentangKamu.jpeg', 'Tere Liye', 'Gramedia Pustaka Utama', 2009, 2, 0.0000, '344 halaman'),
(3, 'Laskar Pelangi', 0.0, 'Mengisahkan tentang perjuangan sepuluh anak dari keluarga miskin di Belitung untuk meraih mimpi mereka di sekolah dasar Muhammadiyah. Novel ini penuh dengan semangat, humor, dan nilai-nilai persahabatan yang mengharukan.', 'LaskarPelangi.jpeg', 'Andrea Hirata', 'Bentang Pustaka', 2005, 3, 0.0000, '528 halaman'),
(4, 'Atomic Habits', 0.0, 'Buku ini akan menjelaskan mengenai suatu hal yang kecil bisa berdampak besar pada kehidupan seseorang. Perubahan-perubahan kecil akan menjadikan sesuatu hal yang luar biasa. Caranya dengan melakukannya secara rutin dan telaten.\r\nSelain itu, dalam buku ini terdapat juga contoh nyata kebiasaan kecil yang memiliki dampak besar.', 'AtomicHabits.png', 'James Clear', 'Gramedia Pustaka Utama', 2019, 2, 0.0000, '356 Halaman'),
(5, 'Berani Tidak Disukai', 0.0, 'Buku ini terdiri dari 5 bab yang mampu mengajarkan bagaimana seseorang mampu menentukan arah hidup. Selain itu, menuntun untuk bebas dari trauma masa lalu dan beban ekspektasi orang lain. \r\nKonsep dari buku ini lebih mengajak untuk berdiskusi dan tidak terkesan menggurui. Jadi, pembaca akan merasa nyaman dan membuka wawasan tentang bagaimana penerimaan diri.', 'BeraniTidakDisukai.jpg', 'Ichiro Kishimi dan Fumitake Koga', 'Gramedia Pustaka Utama', 2016, 1, 0.0000, '350 Halaman\r\n'),
(6, 'Kambing Jantan', 0.0, 'Buku ini merupakan kumpulan cerita ringan yang menghibur dengan sentuhan humor khas Raditya Dika. Melalui gaya tulisan yang sederhana dan lucu, Raditya mampu menghadirkan berbagai kejadian kocak yang dialaminya di luar negeri, mulai dari kesulitan beradaptasi dengan budaya baru, hingga kejadian-kejadian lucu yang terjadi dalam kehidupan sehari-hari.', 'KambingJantan.jpeg', 'Raditya Dika', 'Gagas Media', 2005, 0, 0.0000, '192 Halaman'),
(7, 'Seribu Wajah Ayah', 0.0, 'Seorang anak perempuan yang merantau ke luar negeri kembali ke rumah setelah ayahnya meninggal. Di sana, ia menemukan album foto yang berisi kenangan masa lalunya bersama sang ayah dan belajar memahami berbagai sisi ayahnya yang tidak pernah ia ketahui sebelumnya.', 'SeribuWajahAyah.png', 'Nurun Ala', 'Gramedia Pustaka Utama', 2020, 0, 0.0000, '240 halaman'),
(8, 'Patuhi Rules!', 0.0, 'Kisah tentang sekelompok anak SMA yang terjebak dalam permainan berbahaya yang disebut \"Rules\". Permainan ini penuh misteri dan memaksa mereka untuk mengikuti berbagai aturan yang aneh dan berbahaya.', 'PatuhiRules.jpg', 'Luluk HF', 'Gramedia Pustaka Utama', 2018, 0, 0.0000, '256 halaman'),
(9, 'Rumah Kaca', 0.0, 'Novel sejarah yang berlatar belakang masa penjajahan Belanda di Indonesia. Kisah ini menceritakan tentang perjuangan seorang pemuda bernama Kurniawan untuk melawan penjajah dan mencari jati dirinya.', 'RumahKaca.jpg', 'Pramoedya Ananta Toer', 'Lentera Dipantara', 2002, 0, 0.0000, '448 halaman'),
(10, 'Novel Catatan Pembunuhan Sang Novelis (Malice)', 0.0, 'Novel misteri tentang seorang editor yang dituduh membunuh novelis terkenal. Kisah ini penuh dengan ketegangan dan plot twist yang mengejutkan.', 'NovelCatatanPembunuhanSangNovelis.jpg', 'Keigo Higashino', 'Gramedia Pustaka Utama', 2012, 0, 0.0000, '344 halaman'),
(11, 'Perpustakaan Tengah Malam (The Midnight Library)', 0.0, 'Kisah tentang seorang wanita bernama Nora Seed yang merasa hidupnya gagal dan memutuskan untuk bunuh diri. Namun, di ambang kematian, dia menemukan sebuah perpustakaan ajaib yang berisi buku-buku tentang kehidupan alternatifnya.', 'TheMidnightLibrary.jpg', 'Matt Haig', 'Gramedia Pustaka Utama', 2020, 1, 0.0000, '320 halaman'),
(12, 'Renjana', 0.0, 'Novel tentang cinta dan kehilangan yang berlatar belakang masa Orde Baru di Indonesia. Kisah ini menceritakan tentang dua orang yang jatuh cinta pada masa remaja dan harus berpisah karena situasi politik yang tidak stabil.', 'Renjana.jpg', 'Leila S. Chudori', 'Gramedia Pustaka Utama', 2018, 0, 0.0000, '320 Halaman'),
...
INSERT INTO `readlist` (`id`, `user_id`, `buku_id`) VALUES
(44, 6, 4),
(49, 6, 5),
(53, 6, 2),
(54, 9, 3),
...
(10, 'rosdiyanna', '$2y$10$f9/G7JOJ85jU2IEipaSh5eqLSwlRvAUf2RNK6pEr9kvTfEXCyV6rm', 'Rosdiyanna Safitri');
...
--
ALTER TABLE `komentar`
  MODIFY `komentar_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- Ketidakleluasaan untuk tabel `readlist`
--
ALTER TABLE `readlist`
  ADD CONSTRAINT `readlist_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `readlist_ibfk_2` FOREIGN KEY (`buku_id`) REFERENCES `buku` (`buku_id`);
COMMIT;
